...
class RobotiqScript(URScript):
    ...
    def _rq_get_var(self, var_name, nbytes):
        self._socket_send_string("GET {}".format(var_name), self.socket_name) # modified, it was without the second input
        self._socket_read_byte_list(nbytes, self.socket_name) # modified, it was without the second input
